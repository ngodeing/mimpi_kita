...
import 'fund_pending_model.dart';
export 'fund_pending_model.dart';

class FundPendingWidget extends StatefulWidget {
  const FundPendingWidget({super.key});

  @override
  State<FundPendingWidget> createState() => _FundPendingWidgetState();
}

class _FundPendingWidgetState extends State<FundPendingWidget> {
  late FundPendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FundPendingModel());
  }
