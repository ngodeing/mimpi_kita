                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<DonationsRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final buttonDonationsRecord = snapshot.data!;
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      _model.lessValue =
                                          buttonDonationsRecord.value +
                                              int.parse(
                                                  _model.textController1.text);
                                      setState(() {});
                                      if (_model.lessValue! >
                                          buttonDonationsRecord.target) {
                                        await showDialog(
                                          context: context,
                                        ...
                                        if ((_model.textController1.text != null && _model.textController1.text != '') &&
                                          ...
                                          await DonateRecord.collection
                                              .doc()
                                              .set(createDonateRecordData(
                                                userId: currentUserReference,
                                                donationId: widget.donationid,
                                                value: int.tryParse(_model
                                          ...
                                          await widget.donationid!.update({
                                            ...mapToFirestore(
                                              {
